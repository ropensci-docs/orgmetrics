...
First of all, thanks for considering contributing to `orgmetrics`! 👍
It’s people like you that make it rewarding for us - the project
maintainers - to work on `orgmetrics`. 😊
...
- new_issue:
  <https://github.com/ropensci-review-tools/orgmetrics/issues/new>
- website: <https://docs.ropensci.org/orgmetrics/>
- citation:
  <https://ropensci-review-tools.github.io/orgmetrics/authors.html>
...
Think `orgmetrics` is useful? Let others discover it, by telling them in
...
documentation](https://docs.ropensci.org/orgmetrics/) to see if you can
find a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/ropensci-review-tools/orgmetrics/issues).
...
list](https://github.com/ropensci-review-tools/orgmetrics/issues) to see
...
Using `orgmetrics` and discovered a bug? That’s annoying! Don’t let
...
- Include the version of `orgmetrics` with the following line in your
  `reprex` code:
...
issue](https://github.com/ropensci-review-tools/orgmetrics/issues/new)
...
Care to fix bugs or implement new functionality for `orgmetrics`?
Awesome! 👏 Have a look at the [issue
list](https://github.com/ropensci-review-tools/orgmetrics/issues) and
...
1.  Fork [this
    repo](https://github.com/ropensci-review-tools/orgmetrics/) and
...
The `orgmetrics` coding style diverges somewhat from [the commonly used
...
code readability. Code references in `orgmetrics` are separated by
...
`orgmetrics` code opts for the former style, with the natural result
that one ends up writing
